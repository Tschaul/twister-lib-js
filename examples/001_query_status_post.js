 /*
 * To get the basic functionality of twister-lib-js going, we need to instantiate the 
 ...
 * all methods in twister-lib-js that start with "do", takes a callback function that is run with 
 * the result of the query as argument after the query is completed. So "get" functions return 
 * the result and "do" function call a callback with the result.
 * 
