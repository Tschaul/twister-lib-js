...
var messageVerificationsInProgress = 0;

TwisterCrypto.PubKey.prototype.messageVerify = function ( message, signature, cbfunc )
{    
    
    thisPubKey=this;
    
    messageVerificationsInProgress++;
    
    var timeout=messageVerificationsInProgress*100;
    ...
    setTimeout(function(){
        ...
        cbfunc(Bitcoin.Message.verify(thisPubKey.getAddress(), signature, message, twister_network))
    
    },timeout);
    
}

module.exports = TwisterCrypto;